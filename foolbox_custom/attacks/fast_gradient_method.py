...
class L1FastGradientAttack(L1BaseGradientDescent):
    ...
    def __init__(self, *, random_start: bool = False, EOT: int = 1, loss: str = 'ce', mod: dict = None):
        super().__init__(
            rel_stepsize=1.0, steps=1, random_start=random_start, EOT=EOT, loss=loss, mod=mod,
        )
